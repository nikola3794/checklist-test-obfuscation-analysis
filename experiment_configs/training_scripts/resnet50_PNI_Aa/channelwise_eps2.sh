...
#Specify model
MODEL=resnet_50_PNI_Aa_channelwise
# Specify number of classes
NUM_CLASSES=100
#Specify adversarial parameters
AE_EPS=2.0 # 2.0 or 4.0 used
AE_FGSM_STEP=2.5 # eps=2-->step=2.5 ... eps=4--->step=5.0
AE_N_REPEATS=1
AE_RND_INIT=True

#Other parameters (mostly unchanged between experiments)
CONFIG_ROOT_DIR=${CODE_ROOT_DIR}/experiment_configs/default_training_config_imnet100_scratch.yaml
N_GPU=2

...
@register_model
def resnet34_reluS(pretrained=False, **kwargs):
    """Constructs a ResNet-34 model.
    """
    model_args = dict(block=BasicBlock, layers=[3, 4, 6, 3], act_layer=nn.ReLU6, **kwargs)
    return _create_resnet('resnet34', pretrained, **model_args)
...
@register_model
def resnet50_reluS(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3], act_layer=nn.ReLU6,  **kwargs)
    return _create_resnet('resnet50_reluS', pretrained, **model_args)
